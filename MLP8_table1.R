...
nn.1  <- nnet(as.factor(V535)~., data = train_subset,size=8,decay=1e-5,maxit=100,MaxNWts=150000)
...
nn.1  <- nnet(as.factor(V535)~., data = train_subset,size=8,decay=1e-3,maxit=150,MaxNWts=150000)
predictions5 <- predict(nn.1, test_subset, type = "class")
comparison <- data.frame(actual = as.factor(test_subset$V535), predicted = predictions5)
table(comparison)
...
nn.1  <- nnet(as.factor(V535)~., data = train_subset,size=8,decay=1e-3,maxit=100,MaxNWts=150000)
predictions5 <- predict(nn.1, test_subset, type = "class")
comparison <- data.frame(actual = as.factor(test_subset$V535), predicted = predictions5)
table(comparison)
...
nn.1  <- nnet(as.factor(V535)~., data = train_subset,size=8,decay=1e-1,maxit=100,MaxNWts=150000)
predictions5 <- predict(nn.1, test_subset, type = "class")
comparison <- data.frame(actual = as.factor(test_subset$V535), predicted = predictions5)
table(comparison)
...
nn.1  <- nnet(as.factor(V535)~., data = train_subset,size=8,decay=1e-2,maxit=100,MaxNWts=150000)
predictions5 <- predict(nn.1, test_subset, type = "class")
comparison <- data.frame(actual = as.factor(test_subset$V535), predicted = predictions5)
table(comparison)
